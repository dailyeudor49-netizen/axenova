      ...
      <div className="min-h-screen bg-gray-50 text-gray-900 pb-24 overflow-x-hidden">
        ...
        <main>
          ...
          <div className="bg-gray-900 text-white text-center py-3 text-sm font-medium tracking-wide">
            🚚 Spedizione Gratuita in tutta Italia solo per oggi
          </div>
          ...
          <div className="bg-red-600 text-white text-center py-8 px-4">
            <div className="max-w-2xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-black mb-2 uppercase">Non perdere l&apos;offerta al 50%</h3>
              <p className="font-medium mb-6 text-red-100">Oltre 1.500 ordini oggi. L&apos;offerta sta per terminare.</p>
              <button
                onClick={scrollToForm}
