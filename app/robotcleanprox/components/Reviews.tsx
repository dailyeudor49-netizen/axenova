    ...
    <section className="py-12 px-4 bg-white border-t border-gray-100">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-10">
            ...
            <p className="text-gray-500 font-medium">Basato su oltre 1.500 clienti soddisfatti in Italia</p>
        </div>
              ...
              <div className="flex justify-between items-center mt-auto">
                  {review.verified && (
                    <div className="flex items-center gap-1 text-green-600 text-xs font-bold uppercase bg-green-50 px-2 py-1 rounded">
                        <CheckCircle size={14} /> Acquisto Verificato
                    </div>
                  )}
        ...
        {!showAll && (
            <div className="mt-8 text-center">
                ...
                >
                    {isLoading ? (
                        <>
                            <Loader className="animate-spin" size={20} /> Caricamento...
                        </>
                    ) : (
