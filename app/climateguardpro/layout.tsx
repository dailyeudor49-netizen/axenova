...
export default function ClimateGuardProLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .climateguardpro { font-family: 'Outfit', sans-serif; -webkit-font-smoothing: antialiased; background-color: #030305; }
            .climateguardpro h1, .climateguardpro h2, .climateguardpro h3, .climateguardpro h4, .climateguardpro .font-display { font-family: 'Syne', sans-serif; }
      ...
      <div className="climateguardpro bg-void-950 text-gray-800 overflow-x-hidden selection:bg-neon-500 selection:text-white">
        {children}
      </div>
    </>
  );
