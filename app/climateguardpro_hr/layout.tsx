...
export default function ClimateGuardProHRLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .climateguardpro-hr { font-family: 'Outfit', sans-serif; -webkit-font-smoothing: antialiased; background-color: #030305; }
            .climateguardpro-hr h1, .climateguardpro-hr h2, .climateguardpro-hr h3, .climateguardpro-hr h4, .climateguardpro-hr .font-display { font-family: 'Syne', sans-serif; }
      ...
      <div className="climateguardpro-hr bg-void-950 text-gray-800 overflow-x-hidden selection:bg-neon-500 selection:text-white">
        {children}
      </div>
    </>
  );
