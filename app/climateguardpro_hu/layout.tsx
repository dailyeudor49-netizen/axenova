...
export default function ClimateGuardProHULayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .climateguardpro-hu { font-family: 'Outfit', sans-serif; -webkit-font-smoothing: antialiased; background-color: #030305; }
            .climateguardpro-hu h1, .climateguardpro-hu h2, .climateguardpro-hu h3, .climateguardpro-hu h4, .climateguardpro-hu .font-display { font-family: 'Syne', sans-serif; }
      ...
      <div className="climateguardpro-hu bg-void-950 text-gray-800 overflow-x-hidden selection:bg-neon-500 selection:text-white">
        {children}
      </div>
    </>
  );
