...
export default function ClimateGuardProPLLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .climateguardpro-pl { font-family: 'Outfit', sans-serif; -webkit-font-smoothing: antialiased; background-color: #030305; }
            .climateguardpro-pl h1, .climateguardpro-pl h2, .climateguardpro-pl h3, .climateguardpro-pl h4, .climateguardpro-pl .font-display { font-family: 'Syne', sans-serif; }
      ...
      <div className="climateguardpro-pl bg-void-950 text-gray-800 overflow-x-hidden selection:bg-neon-500 selection:text-white">
        {children}
      </div>
    </>
  );
