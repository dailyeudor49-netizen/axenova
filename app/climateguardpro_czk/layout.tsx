...
export default function ClimateGuardProCZKLayout({
  children,
}: {
  ...
  return (
    <>
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            .climateguardpro-czk { font-family: 'Outfit', sans-serif; -webkit-font-smoothing: antialiased; background-color: #030305; }
            .climateguardpro-czk h1, .climateguardpro-czk h2, .climateguardpro-czk h3, .climateguardpro-czk h4, .climateguardpro-czk .font-display { font-family: 'Syne', sans-serif; }
      ...
      <div className="climateguardpro-czk bg-void-950 text-gray-800 overflow-x-hidden selection:bg-neon-500 selection:text-white">
        {children}
      </div>
    </>
  );
